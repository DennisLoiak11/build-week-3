...
import gerry2 from '../gerrys/gerry2.jpg'
    ...
    return(
        ...
        <section className="col-3 bordogrigio rounded d-none d-lg-block">
            <div>
                <div className="bgimage d-flex justify-content-center">
                    <img className="width0 rounded-circle mt-5" src={gerry2} alt="" />
                </div>
            </div>
            ...
            <div className="d-flex justify-content-between align-items-center bordobot">
                ...
                <div className="me-3"><PersonFillAdd/></div>
            </div>
            <div className="bordobot">
                <div className="m-3">
                <p className="mb-0 text-muted p0">Accedi a strumenti e informazioni in esclusiva</p>
                <p className="p0"><App className="me-1 bg-warning"/>Prova premium gratis</p>
                </div>
            </div>
            <div>
                <p className="m-3 p0"><BookmarkFill className="me-1"/>I miei elementi</p>
            </div>
        </section>
        <section className="col-3 bordogrigio rounded mt-3 fw-semibold d-none d-lg-block">
            <div className="bordobot">
                ...
                <div className="d-flex justify-content-between mb-3"><a className="p0">Eventi</a><Plus/></div>
